...
export const CommandAndFleetRow: React.FC<CommandAndFleetRowProps> = ({
  ...
  const handleTalkToggle = () => {
    ...
    if (!isTalking) {
      setTalkFeedback(
        'Channel open: Voice comms broadcasting to Field Response Unit...'
      );
  ...
  const handleLocationDispatch = () => {
    ...
    setTalkFeedback(
      `Dispatched GPS coordinates [${selectedHotspot?.latitude.toFixed(
        3
      )}°, ${selectedHotspot?.longitude.toFixed(
        3
      )}°] to Rescue Team!`
    );
      ...
      <div className="virevo-card p-4 sm:p-5 flex flex-col justify-between">
        ...
        <div className="flex items-center gap-4 flex-1">
          ...
          <div className="relative h-24 w-28 shrink-0 overflow-hidden rounded-2xl border border-white/10 bg-obsidian-900 shadow-inner">
            ...
            {/* AI Lock Indicator */}
            <div className="absolute top-1.5 left-1.5 flex items-center gap-1 rounded-full bg-black/70 px-2 py-0.5 font-mono text-[8px] text-[#38BDF8] font-bold">
          ...
          <div className="flex-1 space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-obsidian-900 text-[#38BDF8]">
                <Compass
                  size={18}
                  className="compass-needle-animated"
                />
              </div>
              ...
              <div>
                ...
                <p className="text-xs font-bold font-mono text-[#7DD3FC]">
                  W-E · 240° SW
                </p>
              </div>
      ...
      <div className="virevo-card p-4 sm:p-5 flex flex-col justify-between">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-2 font-mono text-[9px] text-slate-400">
            <span>
              Units: <strong className="text-white">6</strong>
            </span>

            <span>·</span>

            <span>
              Personnel: <strong className="text-white">16</strong>
            </span>
          </div>
        ...
        <div className="space-y-3 flex-1 flex flex-col justify-center">
          ...
          {/* Feedback Toast */}
          {talkFeedback && (
            <p className="text-[10px] text-[#38BDF8] font-mono italic animate-pulse">
              {talkFeedback}
            </p>
          )}
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              ...
              className={`flex items-center justify-center gap-1.5 rounded-full py-2 text-xs font-bold transition-all ${
                isTalking
                  ? 'bg-[#38BDF8] text-[#05080D] shadow-[0_0_16px_rgba(56,189,248,0.45)]'
            ...
            >
              <Mic
                ...
                className={
                  isTalking
                    ? 'animate-bounce text-[#05080D]'
                    : 'text-[#38BDF8]'
                }
              />

              <span>
                {isTalking ? 'Transmitting...' : 'Talk'}
              </span>
            </button>
      ...
      <div className="virevo-card p-4 sm:p-5 flex flex-col justify-between">
        ...
        <div className="relative my-2 flex items-center justify-center">
          ...
          <div className="relative w-44 h-24 flex items-center justify-center">
            ...
            <svg
              className="w-full h-full text-[#38BDF8]/70"
              viewBox="0 0 160 80"
            >
              {/* Drone Frame */}
              <line
            ...
            <span className="absolute top-0 left-0 text-[9px] font-mono font-bold text-slate-200 bg-black/70 px-1.5 py-0.5 rounded-md border border-white/10">
              FL <strong className="text-[#22C55E]">98%</strong>
            </span>
            ...
            <span className="absolute top-0 right-0 text-[9px] font-mono font-bold text-slate-200 bg-black/70 px-1.5 py-0.5 rounded-md border border-white/10">
              FR <strong className="text-[#22C55E]">97%</strong>
            </span>
            ...
            <span className="absolute bottom-0 left-0 text-[9px] font-mono font-bold text-slate-200 bg-black/70 px-1.5 py-0.5 rounded-md border border-white/10">
              RL <strong className="text-[#22C55E]">96%</strong>
            </span>
            ...
            <span className="absolute bottom-0 right-0 text-[9px] font-mono font-bold text-slate-200 bg-black/70 px-1.5 py-0.5 rounded-md border border-white/10">
              RR <strong className="text-[#22C55E]">98%</strong>
            </span>
        ...
        <div className="flex items-center justify-center">
          ...
          <div className="w-full text-center rounded-full bg-[#22C55E]/15 border border-[#22C55E]/30 py-2 text-xs font-black text-[#4ADE80] shadow-[0_0_12px_rgba(34,197,94,0.12)]">
