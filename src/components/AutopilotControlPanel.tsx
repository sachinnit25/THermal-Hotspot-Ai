    ...
    <div className="flex flex-col gap-4 w-full">
      ...
      <div className="virevo-card p-4 sm:p-5 space-y-4">
        ...
        <div className="flex items-center justify-between border-b border-white/5 pb-3.5">
          <div>
            ...
            <p className="text-[10px] text-slate-400">
              Autonomous thermal patrol
            </p>
          </div>

          {/* Aerospace Toggle Switch */}
          <button
            onClick={() => setAutopilotEnabled(!autopilotEnabled)}
            className={`relative h-6 w-11 rounded-full transition-colors ${
              autopilotEnabled
                ? 'bg-[#38BDF8] shadow-[0_0_12px_rgba(56,189,248,0.45)]'
                : 'bg-slate-800'
            }`}
          >
            <span
            ...
            <div className="flex items-center gap-1 rounded-full border border-white/5 bg-obsidian-900 p-1">
              ...
              <button
                ...
                className={`px-3 py-0.5 rounded-full text-[10px] font-bold transition-all ${
                  flightMode === 'eco'
                    ? 'bg-[#22C55E] text-black shadow-[0_0_8px_rgba(34,197,94,0.3)]'
              ...
              <button
                ...
                className={`px-3 py-0.5 rounded-full text-[10px] font-bold transition-all ${
                  flightMode === 'smart'
                    ? 'bg-[#38BDF8] text-[#05080D] shadow-[0_0_10px_rgba(56,189,248,0.4)]'
                    : 'text-slate-400 hover:text-white'
                }`}
              >
                Smart
              ...
              <button
                ...
                className={`px-3 py-0.5 rounded-full text-[10px] font-bold transition-all ${
                  flightMode === 'turbo'
                    ? 'bg-[#FF8A00] text-black shadow-[0_0_10px_rgba(255,138,0,0.45)]'
                    : 'text-slate-400 hover:text-white'
                }`}
              >
                Turbo
        ...
        <div className="space-y-1.5">
          ...
          {/* Thermal telemetry segmented gauge */}
            ...
            {Array.from({ length: 16 }).map((_, i) => (
              <div
                ...
                className={`flex-1 h-3 rounded-sm ${
                  i < 12
                    ? 'bg-[#FF8A00] shadow-[0_0_6px_rgba(255,138,0,0.4)]'
                    : 'bg-white/5'
                }`}
              />
            ))}
        ...
        <div className="border-t border-white/5 pt-3.5 space-y-3">
          ...
          <div className="flex items-center justify-between text-[11px]">
            <div className="flex items-center gap-1.5 text-slate-400">
              <Wifi size={13} className="text-[#38BDF8]" />
            ...
            <div className="flex items-center gap-1">
              {Array.from({ length: 16 }).map((_, i) => (
                <div
                  ...
                  className={`flex-1 h-3 rounded-sm ${
                    i < 9
                      ? 'bg-[#38BDF8] shadow-[0_0_6px_rgba(56,189,248,0.35)]'
                      : 'bg-white/5'
                  }`}
                />
              ))}
      ...
      <div className="virevo-card p-4 sm:p-5 flex-1 flex flex-col justify-between">
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="font-mono text-[9px] font-bold text-black bg-[#FF8A00] px-2.5 py-0.5 rounded-full shadow-[0_0_10px_rgba(255,138,0,0.3)]">
            ...
            return (
              <div
                ...
                className={`group rounded-2xl p-2.5 transition-all cursor-pointer border ${
                  isSelected
                    ? 'border-[#38BDF8]/50 bg-[#38BDF8]/10 shadow-[0_0_20px_rgba(56,189,248,0.15)]'
                ...
                <div className="flex items-start justify-between gap-1.5">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-1.5">
                      ...
                      {isHighRisk && (
                        <span className="h-1.5 w-1.5 rounded-full bg-[#FF3B30] animate-ping shrink-0" />
                      )}

                      <h4 className="text-[11px] font-bold text-white truncate group-hover:text-[#38BDF8] transition-colors">
                        {hs.locationName}
                      </h4>
                    </div>
                  ...
                  <span
                    className={`px-2 py-0.5 rounded-full text-[9px] font-bold shrink-0 ${badge.bg} ${badge.text}`}
                  >
                    {badge.label}
                  </span>
